    ...
    for(i=0; i<N_active_loc_BHs; i++)
    {
	    ...
	    flag=1;
            ...
            for(k=0;k<3;k++) {
                ...
                P[n].GravAccel[k] = (P[n].GravAccel[k]*P[n].Mass + BlackholeTempInfo[i].accreted_force[k]) / m_new;
//                P[n].GravAccel[k] = (P[n].GravAccel[k]*m_new + BlackholeTempInfo[i].accreted_force[k])/m_new;
            }
#endif
...
//All.Time, P[n].ID,nan,  P[n].Mass, BPP(n).BH_Mass, mass_disk, BPP(n).BH_Mdot, mdot_disk, dt,nan, BPP(n).DensAroundStar*All.cf_a3inv, BlackholeTempInfo[i].BH_InternalEnergy, BlackholeTempInfo[i].Sfr_in_Kernel,
//                BlackholeTempInfo[i].Mgas_in_Kernel, BlackholeTempInfo[i].Mstar_in_Kernel, MgasBulge, MstarBulge, r0,nan, P[n].Pos[0], P[n].Pos[1], P[n].Pos[2],nan,  P[n].Vel[0], P[n].Vel[1], P[n].Vel[2],nan,
//                BlackholeTempInfo[i].Jgas_in_Kernel[0], BlackholeTempInfo[i].Jgas_in_Kernel[1], BlackholeTempInfo[i].Jgas_in_Kernel[2],nan, BlackholeTempInfo[i].Jstar_in_Kernel[0], BlackholeTempInfo[i].Jstar_in_Kernel[1], BlackholeTempInfo[i].Jstar_in_Kernel[2]
    ...
    if(flagall>0) rearrange_particle_sequence();
#endif
