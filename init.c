	...
	if (P[i].Type == 0)
	  {
        ...
        if(P[i].Type == 5)
        {
            ...
            if(RestartFlag == 0)
            {
                ...
                BPP(i).SinkRadius = All.BlackHoleMaxAccretionRadius; //All.ForceSoftening[5];
#endif
                ...
                double spin_prefac = 0.* All.G * P[i].BH_Mass / C_LIGHT_CODE; // assume initially maximally-spinning BH with random orientation
